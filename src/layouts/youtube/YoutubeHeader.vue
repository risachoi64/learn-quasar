<template>
  <q-header class="bg-white text-gray-8" height-hint="56">
    <q-toolbar>
      ...
      <q-toolbar-title
        shrink
        class="text-subtitle1 text-weight-bolder text-dark"
      >
        RISA CODING
      </q-toolbar-title>
      <q-space />
      ...
      <q-space />
      <q-btn flat round icon="more_vert" color="black" class="q-mr-sm" />
      <q-btn
        outline
        rounded
        icon="account_circle"
